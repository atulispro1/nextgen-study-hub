...
export default function BlogPage() {
  ...
  return (
    <BlogLayout
      ...
      faq={[
      { q: "Is State PSC easier than UPSC?", a: "Competition is lower but syllabus depth is similar." },
      { q: "How many attempts are allowed?", a: "Depends on state rules and age limits." },
      { q: "Can diploma students apply?", a: "Generally graduation is required." },
    ]}>
      {/* INTRODUCTION */}
