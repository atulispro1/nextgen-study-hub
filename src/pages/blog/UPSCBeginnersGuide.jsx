...
export default function BlogPage() {
  ...
  return (
    <BlogLayout
      ...
      faq={[
      { q: "Is UPSC very tough?", a: "It is competitive and lengthy, but with structured preparation, it becomes manageable." },
      { q: "How many hours should I study daily?", a: "6–8 focused hours consistently." },
      { q: "Can I prepare without coaching?", a: "Yes. Many toppers cleared UPSC through self-study." },
      { q: "How many attempts are required?", a: "It varies. Consistency and strategy matter more than attempt count." },
    ]}>
      {/* INTRODUCTION */}
