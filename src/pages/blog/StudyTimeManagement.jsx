...
export default function BlogPage() {
  ...
  return (
    <BlogLayout
      ...
      faq={[
      { q: "How many hours should engineering students study daily?", a: "3–5 focused hours are sufficient." },
      { q: "Is multitasking effective?", a: "No. Focus on one task at a time." },
      { q: "How to stay consistent?", a: "Follow routine daily and track progress weekly." },
    ]}>
      {/* INTRODUCTION */}
