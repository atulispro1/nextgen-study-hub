...
export default function BlogPage() {
  ...
  return (
    <BlogLayout
      ...
      faq={[
      { q: "Is digital marketing good career in 2026?", a: "Yes, demand is increasing rapidly." },
      { q: "Do I need coding for digital marketing?", a: "No, but basic understanding helps." },
      { q: "Can I earn while studying?", a: "Yes, through freelancing and internships." },
    ]}>
