...
export default function BlogPage() {
  ...
  return (
    <BlogLayout
      ...
      faq={[
      { q: "Is DBMS important for software developers?", a: "Yes, database knowledge is essential for backend development." },
      { q: "Is SQL difficult to learn?", a: "No, SQL is one of the easiest programming languages to learn." },
      { q: "Do companies ask DBMS questions in interviews?", a: "Yes, DBMS is a core subject asked in many technical interviews." },
    ]}>
