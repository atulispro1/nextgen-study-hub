...
export default function BlogPage() {
  ...
  return (
    <BlogLayout
      ...
      faq={[
      { q: "Can diploma students get high salary?", a: "Yes, if they develop strong technical skills." },
      { q: "Is B.Tech compulsory after diploma?", a: "No. Skill-based growth can also lead to success." },
    ]}>
      {/* INTRODUCTION */}
