...
export default function BlogPage() {
  ...
  return (
    <BlogLayout
      ...
      faq={[
      { q: "Which government job has the highest salary?", a: "Civil services like IAS and IPS offer some of the highest salaries." },
      { q: "Are government salaries increasing?", a: "Yes, salaries increase through pay commissions and promotions." },
      { q: "Do government jobs include allowances?", a: "Yes, allowances like HRA and TA significantly increase total salary." },
    ]}>
