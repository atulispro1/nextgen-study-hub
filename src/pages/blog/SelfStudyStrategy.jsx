...
export default function BlogPage() {
  ...
  return (
    <BlogLayout
      ...
      faq={[
      { q: "Is coaching necessary to crack exams?", a: "No, many students succeed through self-study." },
      { q: "How many hours should I study?", a: "4–6 focused hours are enough if consistent." },
      { q: "How to stay motivated?", a: "Set small goals and track daily progress." },
    ]}>
      {/* INTRODUCTION */}
