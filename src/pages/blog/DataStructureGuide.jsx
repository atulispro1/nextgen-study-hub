...
export default function BlogPage() {
  ...
  return (
    <BlogLayout
      ...
      faq={[
      { q: "Is Data Structure hard?", a: "No, with consistent practice it becomes logical and enjoyable." },
      { q: "How long to master it?", a: "3–6 months with daily practice." },
      { q: "Which language is best for DSA?", a: "C++, Java, or Python — choose one and stick to it." },
    ]}>
      {/* INTRODUCTION */}
