...
export default function BlogPage() {
  ...
  return (
    <BlogLayout
      ...
      faq={[
      { q: "How many months required to master GK?", a: "6–8 months of consistent study is enough." },
      { q: "Is newspaper necessary?", a: "Helpful, but monthly PDFs are sufficient for most exams." },
      { q: "How to remember GK for long time?", a: "Regular revision + solving MCQs is key." },
    ]}>
      {/* INTRODUCTION */}
