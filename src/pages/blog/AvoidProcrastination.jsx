...
export default function BlogPage() {
  ...
  return (
    <BlogLayout
      ...
      faq={[
      { q: "Is procrastination normal?", a: "Yes. But it must be controlled." },
      { q: "How to stay motivated daily?", a: "Focus on small progress, not big goals." },
      { q: "Can I fix procrastination quickly?", a: "Yes, by starting with micro tasks consistently." },
    ]}>
      {/* INTRODUCTION */}
