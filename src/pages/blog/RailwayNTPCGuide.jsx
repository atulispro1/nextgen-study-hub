...
export default function BlogPage() {
  ...
  return (
    <BlogLayout
      ...
      faq={[
      { q: "Is Railway NTPC tough?", a: "Moderate level, but competition is high." },
      { q: "How many hours should I study?", a: "4–6 focused hours daily are sufficient." },
      { q: "Is coaching necessary?", a: "No, self-study + mock tests can be enough." },
    ]}>
      {/* INTRODUCTION */}
