...
export default function BlogPage() {
  ...
  return (
    <BlogLayout
      ...
      faq={[
      { q: "Should I choose AI project in diploma?", a: "If you understand basics and have guidance, yes." },
      { q: "Can I build project alone?", a: "Yes, but teamwork improves learning experience." },
      { q: "Is simple project enough for good marks?", a: "Yes, if explanation and implementation are strong." },
    ]}>
      {/* INTRODUCTION */}
